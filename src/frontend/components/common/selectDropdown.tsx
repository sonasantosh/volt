...
export default function SelectDropdown({selectLabel}:selectDropdownProps) {
  ...
  return (
    <Box sx={{ minWidth: 200 }} className="inputwrap selectdropdown">
      {selectLabel && <Box component="p">{selectLabel} <Box component="span" className='required-sign'>*</Box></Box>}
